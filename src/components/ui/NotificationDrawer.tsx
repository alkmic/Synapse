...
export function NotificationDrawer({ isOpen, onClose, notifications }: NotificationDrawerProps) {
  ...
  const getIcon = (type: AIInsight['type']) => {
    switch (type) {
      case 'opportunity':
        return <TrendingUp className="w-5 h-5 text-synapse-accent" />;
      case 'alert':
        return <AlertTriangle className="w-5 h-5 text-red-500" />;
      case 'reminder':
        return <Calendar className="w-5 h-5 text-synapse-primary" />;
      case 'achievement':
        return <Bell className="w-5 h-5 text-synapse-light" />;
    }
  };
          ...
          >
            ...
            <div className="p-6 border-b border-slate-200">
              <div className="flex items-center justify-between mb-2">
                <div className="flex items-center gap-3">
                  <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-synapse-primary to-synapse-accent flex items-center justify-center">
                      ...
                      <div className="flex items-start gap-3">
                        ...
                        <div className="flex-1 min-w-0">
                          ...
                          {notification.actionLabel && (
                            <div className="flex items-center gap-1 text-xs font-medium text-synapse-primary">
            ...
            <div className="p-4 border-t border-slate-200">
              <button
                ...
                className="w-full py-2 text-sm text-synapse-primary hover:bg-synapse-primary/10 rounded-lg transition-colors font-medium"
              >
